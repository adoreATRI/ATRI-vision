...
def generate_launch_description():
    camera_config = os.path.join(get_package_share_directory("usb_camera"), "config", "config.yaml")

    tracker_config = os.path.join(
        get_package_share_directory("atri_tracker"), "config", "config.yaml"
    )
    ...
    rviz_config = os.path.join(get_package_share_directory("bringup"), "config", "debug.rviz")
